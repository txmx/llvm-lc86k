# Install script for directory: C:/Users/txmxc/Documents/moms/lc86k-llvm/llvm-project/llvm/tools/llvm-symbolizer
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xllvm-symbolizerx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE FILES "C:/Users/txmxc/Documents/moms/lc86k-llvm/llvm-project/llvm/out/build/x64-Debug/bin/llvm-symbolizer.exe")
endif()
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xllvm-addr2linex" OR NOT CMAKE_INSTALL_COMPONENT)
  install_symlink("llvm-addr2line.exe" "llvm-symbolizer.exe" "bin" "copy")
endif()
